...
func (s *Server) setupRoutes() {
	...
	// Unified file listing endpoint with robust offset-based pagination
	http.HandleFunc("/api/datasets/files-unified", s.fileUploadHandler.ListDatasetFilesUnified)
