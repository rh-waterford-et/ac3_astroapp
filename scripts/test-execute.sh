...
export BATCH_SIZE="5"
export INPUT_DIR_Starlight="data/input"
export OUTPUT_DIR_Starlight="data/output"
export INPUT_DIR_PPFX="data/input"
export OUTPUT_DIR_PPFX="ppfx/data/output"
export INPUT_DIR_Steckmap="steckmap/data/input"
